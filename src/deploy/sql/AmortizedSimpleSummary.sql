...
INTO [costmanagement].[AmortizedCostSummary]
...
EXEC Sp_Spaceused '[costmanagement].[AmortizedCost]';
EXEC Sp_Spaceused '[costmanagement].[AmortizedCostSummary]';

SELECT Count(*) FROM [costmanagement].[AmortizedCost];
SELECT Count(*) FROM [costmanagement].[AmortizedCostSummary];
